...
--
-- Host: 127.0.0.1
-- Tempo de geração: 02-Maio-2025 às 20:11
...
(1, '2025-05-02 18:09:31', 0, 10, 101, 1, 1),
(2, '2025-05-02 18:09:31', 0, 10, 102, 1, 1),
(3, '2025-05-02 18:09:31', 0, 10, 103, 1, 1),
(4, '2025-05-02 18:09:31', 0, 10, 104, 1, 1),
(5, '2025-05-02 18:09:31', 0, 10, 105, 1, 1);
...
CREATE TRIGGER `after_medicoespassagens_insert` AFTER INSERT ON `medicoespassagens` FOR EACH ROW BEGIN
    ...
    -- Atualizar sala de origem (se diferente de 0)
